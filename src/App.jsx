...
const App = () => {
  return (
    ...
    <div className="main-container">
      ...
      <div className="hero-page"><img src={champion}/></div>
      <div className="card-container">
        ...
        <Card image={benfica} name="Barcelona vs. Benfica" date="Wed, Mar 5" time="12:00 PM"/>
        ...
        <Card image={inter} name="Inter vs. Feyenoord" date="Tue, Mar 11" time="1:00 PM"/>
